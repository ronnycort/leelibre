...
func main() {
	...
	fmt.Println("    POST   /api/libros                        - crear libro (admin)")
	fmt.Println("    PUT    /api/libros/{id}                   - modificar libro (admin)")
	fmt.Println("    DELETE /api/libros/{id}                   - eliminar libro (admin)")
	fmt.Println("    GET    /api/categorias                    - listar categorías")
	fmt.Println("    POST   /api/prestamos                     - registrar préstamo (sesión)")
	fmt.Println("    POST   /api/prestamos/{id}/devolver       - devolver libro (dueño o admin)")
	fmt.Println("    GET    /api/usuarios/{id}/recomendaciones - recomendaciones")
	fmt.Println("    GET    /api/reportes/mas-prestados        - top de libros")
	fmt.Println("    GET    /api/reportes/resumen              - varios reportes en paralelo")
